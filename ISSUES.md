...
| [`vllm-project/vllm` #56868](https://github.com/vllm-project/vllm/issues/56868) | GLM-5.3-Flash long-decode degeneration after accumulated reasoning decode | Traced repetitive low-entropy collapse (`= = =`) to recurrent state drift in hybrid KDA layers; proposed orchestrator-level state snapshotting and sequence eviction | Open (Awaiting maintainer / author verification) |
