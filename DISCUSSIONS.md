...
| [`ggml-org/llama.cpp` #21967](https://github.com/ggml-org/llama.cpp/discussions/21967) | HIP/ROCM: Memory-usage growing until server crashes | Isolated ~7.5 GB "unaccounted" swell to ROCm HSA buddy allocator fragmentation and unpruned rocBLAS GEMM scratchpads under dynamic agentic sequence lengths; explained the ~82% VRAM block-coalescing failure threshold and defined mitigations (`--fit-target 0.80`, `ROCBLAS_INTERNAL_GEMM_CACHE_SIZE=0`, disabling graph capture) | Open (Awaiting author response) |
